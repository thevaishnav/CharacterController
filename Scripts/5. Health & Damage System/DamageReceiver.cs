...
namespace CCN.Health
{
    ...
    public class DamageReceiver : MonoBehaviour
    {
        ...
        private UnityEvent<float, IHealer> onHeal;
        ...
        private void Reset()
        {
            ...
            {
                var hitBox = new HitBox(child) { name = child.name };
                hitBoxes.Add(hitBox);
            }
            #endif
        }
        ...
        public void AddOnHealListener(UnityAction<float, IHealer> call) => onHeal.AddListener(call);
        ...
        public void RemoveOnHealListener(UnityAction<float, IHealer> call) => onHeal.RemoveListener(call);
        ...
        public void Heal(float amount, IHealer healer)
        {
        ...
        /// <param name="amount"> How much health to heal </param>
        /// <param name="healer"> The healer that healed this object </param>
        protected virtual void OnHeal(float amount, IHealer healer)
        {
            health += amount;
